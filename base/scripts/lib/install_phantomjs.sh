...
apt-get install -y libfreetype6 libfreetype6-dev fontconfig
...
cd /usr/local/share/
curl -L -O https://storage.googleapis.com/google-code-archive-downloads/v2/code.google.com/phantomjs/phantomjs-${PHANTOMJS_VERSION}-linux-${ARCH}.tar.bz2
